  ...
  <body>
    <header>
      ...
      <div class="logout-button">
        <a href="src/login.php"><iconify-icon icon="material-symbols:logout" width="30" class="align-middle p-3"></iconify-icon>Logout</a>
      </div>
    </header>
    ...
    <div class="kotak-isi">
        <div class="container">
            <p class="fw-bold">Nilai Akhir : <?php echo $data['nama'] ?></p>
        ...
        <tbody>
            <?php foreach ($nilai_akhir as $nilai): ?>
                <tr>
                    ...
                    <td><?php echo htmlspecialchars($nilai['mutu']); ?></td>
                </tr>
            <?php endforeach; ?>
        </tbody>
    </table>
