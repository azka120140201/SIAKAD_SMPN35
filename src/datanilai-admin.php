...
<body>
    ...
    <div class="kotak-isi">
        ...
        <div class="dropdown container ml-3 mb-3">
            <button class="btn border-dark dropdown-toggle" style="background-color: #C6D8AF;" type="button" id="kelas"
                data-bs-toggle="dropdown" aria-expanded="false">
                Pilih Kelas
            </button>
            <ul class="dropdown-menu" aria-labelledby="kelas">
                <li class="dropdown-item" href="#">kelas 1</li>
                <li class="dropdown-item" href="#">kelas 2</li>
                <li class="dropdown-item" href="#">kelas 3</li>
            </ul>
        </div>
        <!-- /dropdown kelas -->
